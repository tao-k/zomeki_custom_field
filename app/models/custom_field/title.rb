class CustomField::Title < ApplicationRecord
  ...
  # Content
  belongs_to :content, :foreign_key => :content_id, :class_name => 'CustomField::Content::Title'
  validates :content_id, :presence => true

  has_many :items, foreign_key: :title_id, class_name: 'CustomField::Item', dependent: :destroy
